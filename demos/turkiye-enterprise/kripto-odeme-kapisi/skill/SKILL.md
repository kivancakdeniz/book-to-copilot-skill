...
2. Sentetik KRP-1.0 kuralları için [company-policy.md](./references/company-policy.md).
...
5. Eksik, çelişkili ve kapsam dışı varyantlar için [scenario-guide.md](./references/scenario-guide.md).
