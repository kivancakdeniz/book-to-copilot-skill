...
1. Resmi kaynağın kısa yöntem soruları için [public-method.md](./references/public-method.md).
2. Sentetik BTK-1.0 kuralları için [company-policy.md](./references/company-policy.md).
3. Kanonik vaka olguları için [evidence-map.md](./references/evidence-map.md).
4. Zorunlu yanıt biçimi için [output-schema.md](./references/output-schema.md).
5. Eksik, çelişkili, canlı ve toplulaştırılmış varyantlar için [scenario-guide.md](./references/scenario-guide.md).
