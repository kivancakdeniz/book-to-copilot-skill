...
For **M&A, finance, and competition law teams**. Separates preliminary indicators from the legal notification and closing gate.
...
| --- | --- |
| Decision class | `legal-notification-review` |
| Option | `hold-closing` |
| Required rules | 7 identifiers |
| Human route | Rekabet Hukuku Danışmanı · Finans · Sponsor |
