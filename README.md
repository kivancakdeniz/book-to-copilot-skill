...
> This public downstream is developed as **book-to-copilot-skill**. See
> [DOWNSTREAM.md](DOWNSTREAM.md) for its Copilot compatibility goals and sync policy.
...
- **Don't redistribute without rights.** Publishing or sharing a generated skill of a copyrighted work can infringe the rights holder. Keep skills of third-party books non-public unless the relevant rights permit sharing. Internal docs, your own writing, and openly-licensed material are fine to share within the bounds of their license.
...
MIT applies to the converter, downstream modifications, and repository-authored
synthetic demo content, policies, cases, and articles. External sources retain
their own rights and, unless explicitly stated otherwise, are represented only
by metadata, source links, and short independently written method summaries.

See [NOTICE.md](NOTICE.md),
[THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md),
[Licensing and reuse](docs/LICENSING-AND-REUSE.md),
[Security](SECURITY.md), and
[Responsible use](docs/RESPONSIBLE-USE.md). The public site ZIP must include the
root license and third-party notices; the release factory task handles this.
